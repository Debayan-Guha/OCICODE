instances = {
  ...
  "flipkart_dev_spoke1_app_vm" = {

    instance_availability_domain     = "AD1"
    instance_cmp                     = "flipkart_dev_spoke1_compute_and_storage_cmp"
    instance_assign_public_ip        = false
    instance_subnet                  = "flipkart_dev_spoke1_vcn_app_private_subnet"
    instance_memory_in_gbs           = "24"
    instance_ocpus                   = "2"
    instance_boot_volume_size_in_gbs = "70"
    instance_image_id                = "ocid1.image.oc1.eu-frankfurt-1.aaaaaaaaoiwaatpf6sjtuhyoupgloykq72wydgv2u36q6wqqjxke5vkwmyzq" # Hub VM custom image ID
