...
hub_inner_cmps = {
  ...
  "flipkart_dev_hub_network_cmp" = {
    cmp_description = "Hub Network Compartment"
  }
  "flipkart_dev_hub_compute_and_storage_cmp" = {
...
spoke1_inner_cmps = {
  ...
  "flipkart_dev_spoke1_network_cmp" = {
    cmp_description = "Spoke 1 Network Compartment"
  }
  "flipkart_dev_spoke1_compute_and_storage_cmp" = {
